        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="./modules/quanlylienhe/xuly.php?idlienhe=<?php echo $row['id_lienhe'] ?>"><button class="btn1 ">Xóa</button> </a>
                    <a href="index.php?action=quanlylienhe&query=sua&idlienhe=<?php echo $row['id_lienhe'] ?>"><button class="btn1 ">Sửa</button> </a>
